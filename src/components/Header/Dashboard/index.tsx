...
import iconPortfolio from "../../../assets/Dashboard/Header/icon-portfolio.svg";
import tele from "../../../assets/Dashboard/Header/tele.svg";
import twitter from "../../../assets/Dashboard/Header/twitter.svg";
import discord from "../../../assets/Dashboard/Header/discord.svg";
...
const HeaderDashboard = () => {
  ...
  const handleSetRouteName = () => {
    ...
    if (textInRoute && textInRoute.length === 0) {
      setTextActive("");
    } else {
