...
const DetailPage = ({ data, action }: any) => {
  ...
  return (
    <DetailContainer>
      ...
      <BlockStakingRewards>
        <BlockStakingRewardsTitle>Available reward</BlockStakingRewardsTitle>
        <BlockStakingRewardsNumber>
          {data.values}
          <span>KIB</span>
        </BlockStakingRewardsNumber>
      ...
      <BtnGroup isclaimed={data.isClaimed} theme={theme}>
        <ButtonCommon
          style={{
            pointerEvents: "none",
          }}
