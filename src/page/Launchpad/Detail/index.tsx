            ...
            {(!isMobile && activeTab === 1) || (isMobile && activeTab === 2) ? (
                  ...
                  <BlockTableBox className={theme}>
                    ...
                    <BlockTableRowClaim>
                      ...
                      <p>
                        ...
                        users are facing with problems include{" "}
                      </p>
                      <ul>
                        <li>
                        ...
                        <li>
                          ...
                          users on Telegram encounter difficulties transitioning
                          to Web
                          <span
                            style={{ color: "#92929E" }}
                            className="font-DMMono"
                          ...
                          , impeding their exploration of decentralized
                          applications and blockchain services.
                        </li>
                      </ul>
                    </BlockTableRowClaim>
                    <BlockTableRowClaim>
                      ...
                      <ul>
                        ...
                        <li>
                          ...
                          users, it seamlessly guides Web
                          <span
                            style={{ color: "#92929E" }}
                            className="font-DMMono"
                          >
                          ...
                          in in the fastest and most effective way
                        </li>
                        <li>
                          ...
                          blockchains to Kibble DEX, enabling direct token swaps
                          to TON from any supported chain.
                        </li>
                      </ul>
                    </BlockTableRowClaim>
                    <BlockTableRowClaimImage>
                    ...
                    <BlockTableRowClaim>
                      ...
                      <ul>
                        <li>
                          With over a decade in Blockchain and Web
                          <span
                            style={{ color: "#92929E" }}
                            className="font-DMMono"
                          >
                          ...
                          , he is now working as CTO at Meta Tech company
                        </li>
                        <li>
                      ...
                      <ul>
                        ...
                        <li>
                          Developed projects based on a range of Web
                          <span
                            style={{ color: "#92929E" }}
                            className="font-DMMono"
                          >
                          ...
                          technology including the EVM, Hyperledger Fabric and
              ...
              <BlockLeftAboutToken>
                <BlockLeftAboutTokenCard>
                  <h1>tokenomics</h1>
                  <div className="img-info">
                    <img src="/static/Tokenomics.svg" alt="tokennomic" />
                  </div>
                  <BlockLeftAboutTokenCardContent>
                    <BlockTableRow>
              ...
              <>
                  ...
                  <FairBox>
                    ...
                    <BlockRightBox
                      style={{
                        ...
                        paddingBottom: !isInReward ? "50px" : "24px",
                      }}
                    >
                      {!isInReward ? (
                        <>
                ...
                <BlockRightCard>
                  ...
                  <BlockStepsTitle>
                    ...
                    <p
                      style={{
                        color: theme === "dark" ? "#EEEEF0" : "#007AF5",
                      }}
                    >
                      Pool Start
                    </p>
              ...
              <>
                ...
                <BlockRightCard>
                  <BlockStepsTitle className={theme}>
                    ...
                    <p
                      style={{ color: theme === "light" ? "#007AF5" : "#fff" }}
                    >
                      Invest
                    </p>
                    <BlockStepsTitleItem className={theme}>
