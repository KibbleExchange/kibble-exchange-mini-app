...
const CreatePoolConfirm = ({
  ...
  const handleConfirm = async () => {
    try {
      // const respon: any = {
      //   "valid_until": 1714045361,
      //   "query_id": null,
      //   "messages": [
      //     {
      //       "to": "EQC87RZ-a1aDNAFT4lZh35FH_ZXgxN4t8XaXTQ-gSgWjUPDn",
      //       "amount": 600055555,
      //       "payload": "te6ccsEBAgEAaAA7LQFvD4p+pQAAAAAAAAAAUBKlI9QIAO87mQKicbKgHIk4pSPP4k5xhHqutqYgAB7USnesDnCcED8uUQMBAFX8+eWPgAIqFqMWTE1aoxM/MRD/EEluAMqKyKvv/FAn4CTTNIDD6gJUpHqBPDKBaw=="
      //     },
      //     {
      //       "to": "EQBhbmdZvQsjiyYI_B5vHKYX9limJsZ1cZ78Jf0KtosZDzYd",
      //       "amount": 600055555,
      //       "payload": "te6ccsEBAgEAZQA4LQFpD4p+pQAAAAAAAAAAID6YAO87mQKicbKgHIk4pSPP4k5xhHqutqYgAB7USnesDnCcED8uUQMBAFX8+eWPgAvUgy7pQ0b/p2ZPzv6ZiN3NVQnbIdVCBhSPKiY2b5zsigJUpHqBiXdCYQ=="
      //     }
      //   ]
      // }
      // const respons = await tonConnectUI?.sendTransaction(
      //   {
      //     validUntil: respon.valid_until,
      //     messages: respon.messages.map((message: any) => ({
      //       address: message.to,
    ...
    try {
      ...
      if (res.status === 200) {
        ...
        if (result) {
          setLoadingWaitPool(false);
          navigate(
            `/liquidity/provide?from=${asset0.contract_address}&to=${asset1.contract_address}`
          );
        } else {
          setLoadingWaitPool(true);
        }
