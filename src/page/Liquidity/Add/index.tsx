...
import { SwapDetailButton } from "../../../components/Loader/styled";

const TON_ADDRESS: any = process.env.REACT_APP_TON_ADDRESS;

const KIBBLE_ADDRESS: any = process.env.REACT_APP_TON_ADDRESS;
        ...
        return (
          <SwapContent>
            ...
            >
              ...
              <SwapDetail
                style={{
                  height: showDetail ? `140px` : "0px",
                }}
              >
                <SwapDetailBlock>
                  <SwapDetailRow className={theme}>
                    <p>
                      APY <span className="font-DMMono">30d:</span>
                    </p>
  ...
  const onSettingMainButton = () => {
    ...
    if (wallet) {
      if (isLoading) {
        ...
        if (openConfirmModal) {
          ...
          textBtn = "Add Liquidity";
        }
      } else {
        textBtn = `Insufficient ${asset0?.symbol} or ${asset1?.symbol} balance`;
      }
    } else {
    ...
    postEvent("web_app_setup_main_button", {
      ...
      is_active:
        ...
        (isEnoughBalance() && !isLoading && textBtn === "Add Liquidity"),
      is_visible: true,
    });
  };
